...
public class OrderBook {
    ...
    private List<Trade> matchBuyOrder(OrderRequest buyOrder) {
        ...
        while (!sellOrders.isEmpty() && buyOrder.notionalAmount > 0 && buyOrder.price >= sellOrders.peek().price) {
    ...
    private List<Trade> matchSellOrder(OrderRequest sellOrder) {
        ...
        while (!buyOrders.isEmpty() && sellOrder.notionalAmount > 0 && sellOrder.price <= buyOrders.peek().price) {
